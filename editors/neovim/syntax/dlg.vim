...
" Match [...] preceded by whitespace (not at line start, which would be a node)
syn match dlgTag /\s\zs\[[^\]]*\]/ contains=dlgTagBracket,dlgTagName,dlgTagComma
syn match dlgTagBracket /[\[\]]/ contained
